 ...
 */
/*
*This servlet handles maintenance task operations such as:
* Viewing all maintenance tasks
* Adding new tasks
...
public class MaintenanceTaskServlet extends HttpServlet {
    ...
    /**
     * Handles GET request to display all maintenance tasks
     */
    @Override
